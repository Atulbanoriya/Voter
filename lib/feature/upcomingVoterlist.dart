...
import 'package:voting_app/model/candidate.dart';
 class UpComingVoterList extends StatefulWidget {
   const UpComingVoterList({super.key, Map<String, dynamic>? userData});

   @override
   State<UpComingVoterList> createState() => _UpComingVoterListState();
 }

 class _UpComingVoterListState extends State<UpComingVoterList> {
   ...
   Future<void> fetchCandidates() async {
     final snapshot = await FirebaseFirestore.instance.collection('UpcomingElection').get();
